...
INSERT INTO `django_apscheduler_djangojob` VALUES ('resume_job_matching','2025-06-27 14:14:45.738183',_binary '��4\0\0\0\0\0\0}�(�version�K�id��resume_job_matching��func��&match.services:run_resume_job_matching��trigger��apscheduler.triggers.interval��IntervalTrigger���)��}�(hK�timezone��builtins��getattr����zoneinfo��ZoneInfo����	_unpickle���R��\rAsia/Shanghai�K��R��\nstart_date��datetime��datetime���C\n\�-C��h��R��end_date�N�interval�h\Z�	timedelta���K\0MK\0��R��jitter�Nub�executor��default��args�)�kwargs�}��overwrite_existing��s�name��run_resume_job_matching��misfire_grace_time�K�coalesce���\rmax_instances�K�\rnext_run_time�hC\n\�-C��h��R�u.');
...
-- Dump completed on 2025-06-27 13:21:33
